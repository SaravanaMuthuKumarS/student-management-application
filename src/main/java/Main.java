...
public class Main {
    ...
    public void startApplication() {
        ...
        while (exit) {
            ...
            logger.info("Choice picked by User is {}", choice);
            switch (choice) {
                case 1:
                    ...
                    logger.info("Choice picked by User in creation process is {}", access);
                    System.out.println();
                    switch (access) {
                        case 1:
                ...
                case 2:
                    if (adminController.isAdminAvailable()) {
                        ...
                        System.out.println("\n -----> Press Any key and Enter for Previous Menu\n");
                        choice = scanner.nextInt();
                        logger.info("Choice picked by User in fetching process is {}", choice);
                        System.out.println();
                        switch (choice) {
                            case 1:
                ...
                case 3:
                    ...
                    System.out.println("\n -----> Press Any key and Enter for Previous Menu\n");
                    choice = scanner.nextInt();
                    logger.info("Choice picked by User in searching process is {}", choice);
                    System.out.println();
                    switch (choice) {
                        case 1:
                ...
                case 4:
                    if (adminController.isAdminAvailable()) {
                        ...
                        System.out.println();
                        choice = scanner.nextInt();
                        logger.info("Choice picked by User in removal process is {}", choice);
                        switch (choice) {
                            case 1:
                ...
                case 5:
                    if (adminController.adminValidate()) {
                        ...
                        System.out.println();
                        choice = scanner.nextInt();
                        logger.info("Choice picked by User in Admin process is {}", choice);
                        switch (choice) {
                            case 1:
