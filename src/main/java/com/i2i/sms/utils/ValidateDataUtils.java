...
public final class ValidateDataUtils {
     ...
     * </p>
     * @param str string that need to be validated
     ...
     * </p>
     *
     * @param checkInteger Integer value that need to be verified.
     * @param startInteger Starting integer value for searching range.
     * @param endInteger   End integer value for searching range.
     * @return boolean value whether present in given range or not.
     **/
    public static boolean rangeValidator(int checkInteger, int startInteger, int endInteger) {
        return startInteger <= checkInteger && checkInteger <= endInteger;
    }
